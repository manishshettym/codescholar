...
from python_graphs.program_graph import ProgramGraph, ProgramGraphNode
...
def nx_to_program_graph(graph: nx.DiGraph):
    ...
    graph_nodes = sorted(graph.nodes.items(), key=lambda x: x[1]["relpos"])
    ...
    for edge in graph.edges:
        ...
        new_edge = pgdata.Edge(id1=n1, id2=n2, type=edge_type.name)
