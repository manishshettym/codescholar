def init_encoder_configs(parser, arg_str=None):
    ...
    enc_args.add_argument("--node_anchored", action="store_true", help="whether to use node anchoring in training")
...
def init_optimizer_configs(parser):
    ...
    opt_parser.add_argument("--opt-scheduler", dest="opt_scheduler", type=str, help="Type of optimizer scheduler. default: none")
    opt_parser.add_argument("--opt-restart", dest="opt_restart", type=int, help="Number of epochs before restart, default: 0")
